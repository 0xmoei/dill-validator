...
--exec-http --exec-http.api eth,net,web3 --exec-http.port 8555 --exec-port 30304 --exec-discovery.port 30304 --exec-ws --exec-ws.port 8556 --exec-syncmode full --exec-mine=false --accept-terms-of-use "
